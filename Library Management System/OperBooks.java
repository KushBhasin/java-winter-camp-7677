...
// Perform operations like add, check-in, check-out,Valid books,Update books
import java.util.Scanner;

public class OperBooks {

    InfoBook theBooks[] = new InfoBook[50];
    public static int count;

    Scanner input = new Scanner(System.in);

    public int compareBookObjects(InfoBook b1, InfoBook b2) {
    ...
    public void addBook(InfoBook b) {
    ...
    public void checkInBook(InfoBook b) {
        for (int i = 0; i < count; i++) {
