...
public class OperStudents {

    Scanner input = new Scanner(System.in);
    InfoStudent theStudents[] = new InfoStudent[50];

    public static int count = 0;

    public void addStudent(InfoStudent s) {
    ...
    public void checkOutBook(OperBooks book) {
    ...
    public void checkInBook(OperBooks book) {
        int studentIndex = this.isStudent();
        if (studentIndex != -1) {
            ...
            InfoStudent s = theStudents[studentIndex];
